...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./styles/components/admin-dashboard/admin-cards.css">
  ...
  <body>
    ...
    <div class="body__wrapper">
      <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar__middle">
          ...
          <li>
            <a href="addUser.php" class="sidebar__item addUser">
        ...
        <div class="sidebar__bottom">
          ...
          <div class="info">
            ...
            <img src="./public/jp.png" alt="user" class="info__img">
            <span>
      ...
      <main class="dashboard">
        ...
        <section class="dashboard__cards container section">
          <div class="card card__1">
            <h2 class="card__title title1">Leave Requests Submitted</h2>
          ...
          <div class="card card__2">
            <h2 class="card__title title2">Employees Currently on Leave</h2>
            <div class="card__number">
              <h3 class="card__number-txt"><?php echo $currentyOnLeave; ?></h3>
            </div>
          </div>


          <div class="card card__3">
            <h2 class="card__title">Monthly Leave Activity</h2>
            <canvas id="leave__graph" class="leave__graph" width="400" height="300"></canvas>
          </div>
        </section>
        ...
        <section class="activity container section">
          <div class="activity__wrapper">
            <div class="activity__top">
              <h2 class="activity__header">Admin Activity Snapshot</h2>
            </div>
            <hr>
            <div class="activity__bottom">
            <p><strong>Total Admin Actions Today:</strong> 7</p>
    ...
    <script src="./src/admin/admin-chart.js"></script>
